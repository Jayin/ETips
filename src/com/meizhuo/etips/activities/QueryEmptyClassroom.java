...
public class QueryEmptyClassroom extends BaseUIActivity implements
	...
	private TextView tv_loadInfo, tv_switch, tv_title;
	...
	protected void initLayout() {
		btn_exit = _getView(R.id.acty_query_back);
		btn_switch = _getView(R.id.acty_query_rely_switch);
		tv_switch = (TextView) _getView(R.id.acty_query_tv_switch);
		tv_title = (TextView) _getView(R.id.acty_query_tv_title);
	...
	private void switchView() {
		if (status == 0) {
			tv_title.setText("课室查询");
			tv_switch.setText("查询");
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.acty_query_back:
			closeActivity();
			break;

		case R.id.acty_query_rely_switch:
			if (status == 0) {
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView==null){
				h = new ViewHolder();
				convertView  = LayoutInflater.from(getContext()).inflate(R.layout.item_lv_emptyclassroom, null);
				h.tv_roomNumber = (TextView)convertView.findViewById(R.id.item_lv_room);
				h.iv1 = (ImageView)convertView.findViewById(R.id.item_lv_emptyclassroom_1);
				h.iv2 = (ImageView)convertView.findViewById(R.id.item_lv_emptyclassroom_2);
				h.iv3 = (ImageView)convertView.findViewById(R.id.item_lv_emptyclassroom_3);
				h.iv4 = (ImageView)convertView.findViewById(R.id.item_lv_emptyclassroom_4);
				h.iv5 = (ImageView)convertView.findViewById(R.id.item_lv_emptyclassroom_5);
