...
public class TweetAPI {
	...
	public static String BaseUrl = "http://etipsweb.duapp.com/ETipsproject/";
	...
	private String _regist(String nickname, String account, String id, String psw) {
		...
		params.put("id", id);
		params.put("psw", psw);
		return request("post", params, BaseUrl + "regist.php");
	}
	/**
	 * 注册：
	 * 
	...
	public String login(String account, String psw) {
		...
		params.put("account", account);
		params.put("psw", psw);
		return request("post", params, BaseUrl + "login.php");
	}
	...
	public String reSetPsw(String account, String resetpsw, long validtime) {
		...
		return request("post", params, BaseUrl + "resetpsw.php");
	}
	...
	public String _getgetTopicList(){
		return request("get", null, BaseUrl + "topiclist.php");
	}
	/**
	...
	public List<Topic> getTopicList() {
		...
		String json = request("get", null, BaseUrl + "topiclist.php");
	...
	private String getTopic(String topic_id, String page) {
		...
		return request("get", params, BaseUrl + "topic.php");
	}
    /**
     * 获取tweet 列表
     * @param topic_id
	...
	public String compose(String topic_id, String content, String author,
		...
		return request("get", params, BaseUrl + "post.php");
	}
	...
	public String comment(String topic_id, String article_id, String content,
		...
		params.put("incognito", incognito);
		params.put("content", content);
		return request("get", params, BaseUrl + "comment.php");
	}
	...
	private String getComment(String topic_id, String article_id) {
		...
		params.put("topic_id", topic_id);
		params.put("article_id", article_id);
		return request("get", params, BaseUrl + "getcomment.php");
	}
	...
	public String getCurrent() {
		return request("get", null, BaseUrl + "current.php");
	}
}
